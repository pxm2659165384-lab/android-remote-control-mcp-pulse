    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(padding)) {
            ...
            if (config.notifications.filterMode != NotificationFilterMode.ALL) {
                ...
                Text(
                    stringResource(R.string.notification_filter_selected_count, config.notifications.filterApps.size),
...
@Composable
private fun NotificationFilterMode.toDisplayLabel(): String =
    when (this) {
        NotificationFilterMode.ALL -> stringResource(R.string.notification_filter_mode_all)
        NotificationFilterMode.WHITELIST -> stringResource(R.string.notification_filter_mode_whitelist)
        NotificationFilterMode.BLACKLIST -> stringResource(R.string.notification_filter_mode_blacklist)
    }
