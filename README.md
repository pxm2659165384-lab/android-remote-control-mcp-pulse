...
- `GET /stop` as the emergency stop path.
- `GET /status`, `/biometrics`, `/matrix/config`, `/gamepads/refresh`, and `/playMedia`.
- Windows PC XInput bridge scripts for controller vibration through a phone-hotspot LAN route.

The complete Pulse Link project guide is in [docs/PULSE_LINK_FINAL_GUIDE.md](docs/PULSE_LINK_FINAL_GUIDE.md). The PC controller bridge guide is in [docs/PULSE_LINK_HOTSPOT_BRIDGE.md](docs/PULSE_LINK_HOTSPOT_BRIDGE.md).

Current Pulse Link source snapshot: 2026-07-08 fix60/fix61 working tree.

[![CI](https://github.com/pxm2659165384-lab/android-remote-control-mcp-pulse/actions/workflows/ci.yml/badge.svg)](https://github.com/pxm2659165384-lab/android-remote-control-mcp-pulse/actions/workflows/ci.yml)
...
1. Open the [Releases](https://github.com/pxm2659165384-lab/android-remote-control-mcp-pulse/releases) page on your phone's browser
...
1. Download the APK from the [Releases](https://github.com/pxm2659165384-lab/android-remote-control-mcp-pulse/releases) page
...
If you cloned without submodules, run `git submodule update --init vendor/cloudflared vendor/ngrok-java` before building tunnel-enabled variants.
